...
**Key Features:**
*   **Physics-Based Data Generation:** Uses the Transfer Matrix Method (TMM) to simulate realistic training data with configurable material properties (GenericAlloy, GenericAdhesive).
